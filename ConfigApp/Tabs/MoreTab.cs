...
namespace ConfigApp.Tabs
{
    public class MoreTab : Tab
    {
        ...
        protected override void InitContent()
        {
            ...
            PushRowPair("Enjoying the mod12321321542345? Buy me a coffee! :)", GenerateInfoButton("PayPal", (sender, eventArgs) =>
            {
                System.Diagnostics.Process.Start("https://www.twitch.tv/psp1g");
            }));
            PopRow();
